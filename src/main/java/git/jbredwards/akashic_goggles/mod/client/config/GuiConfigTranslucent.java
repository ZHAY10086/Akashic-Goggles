...
public class GuiConfigTranslucent extends GuiConfig
{
    public GuiConfigTranslucent(@Nonnull final GuiScreen parentScreen, @Nonnull final List<IConfigElement> configElements, @Nonnull final String modID,
    ...
    public void initGui() {
        ...
        ? new GuiConfigEntries.CategoryEntry(this, entryList, entry.getConfigElement()) {
            ...
            protected GuiScreen buildChildScreen() {
                return new GuiConfigTranslucent(owningScreen, configElement.getChildElements(), owningScreen.modID,
